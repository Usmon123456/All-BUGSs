...
export const BUGS: Bug[] = [
  {
    id: '1',
    title: 'Infinite Loop in Auth Middleware',
    description: 'A recursive call in the authentication guard causes the browser to hang during login attempts.',
    severity: Severity.CRITICAL,
    mediaUrl: 'https://picsum.photos/seed/bug1/800/450',
    mediaType: 'image',
  ...
  },
  {
    ...
    mediaUrl: 'https://picsum.photos/seed/bug3/800/450',
    mediaType: 'image',
