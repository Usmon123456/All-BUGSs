...
export const BUGS: Bug[] = [
  ...
  },
  {
    ...
    description: 'Something was searched through the search input and something was selected from the filter. Then, when the 'Clear All Filters' button is clicked, the words in the search input are also being cleared. If the search input also needs to be cleared, there should be a separate Clear Al" button.',
    severity: Severity.HIGH,
