...
export const BUGS: Bug[] = [
  ...
  },
  {
    ...
    description: 'There are several minor issues only in the Learning section. When entering the Learning section, the navbar should indicate it is active by changing color. Also, in the navbar, the "Enroll Now" button has been replaced by a user icon. Cart icon',
    severity: Severity.MEDIUM,
