...
export const BUGS: Bug[] = [
  ...
  },
  {
    ...
    description: 'When I click the "Article Review" button in the Home section, it says "You are already logged in." But when I click the "Article Review" button in the About section, it takes me to a specific page.',
    severity: Severity.MEDIUM,
  ...
  },
  {
    id: '15',
    title: 'Suggestion',
    description: 'When navigating to the YouTube page, opening it with target="_blank" would make it much more convenient for the user.',
    severity: Severity.MEDIUM,
  ...
  },
  {
    ...
    description: 'A course is found through the search, but when the search button is clicked again, all courses are displayed.',
    severity: Severity.MEDIUM,
  ...
  },
  {
    ...
    description: 'When the actions in the video are done quickly and the Clear All Filters button is clicked, it navigates to an unknown page.',
    severity: Severity.HIGH,
  ...
  },
  {
    ...
    description: 'There are 3 courses, but 2 identical courses are shown at the bottom.',
    severity: Severity.LOW,
  ...
  },
  {
    ...
    description: 'The images here are different. Logically, they should be the same.',
    severity: Severity.MEDIUM,
    mediaUrl: '/items/rasm8.png',
    mediaType: 'image',
  ...
  },
  {
    ...
    description: 'I tried to edit a review, wrote Im funny and after saving, meaningless characters were added.',
    severity: Severity.LOW,
    ...
    description: 'There are several minor issues only in the Learning section. When entering the Learning section, the navbar should indicate it is active by changing color. Also, in the navbar, the "Enroll Now" button has been replaced by a user icon. Cart icon not',
    severity: Severity.MEDIUM,
    ...
    description: 'It says that 2 ratings have been given in other places, but in the Home section, this is not the case.',
    severity: Severity.MEDIUM,
    ...
    id: '23',
    title: 'Suggestion',
    description: 'The account avatar should be enlarged and placed side by side with the user information.',
    severity: Severity.MEDIUM,
